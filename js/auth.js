...
// Hash SHA-256 de la contraseña real de carga ("bodega05"). Para generar el
// hash de una nueva contraseña, abre la consola del navegador en esta página
// y ejecuta:
//   crypto.subtle.digest('SHA-256', new TextEncoder().encode('tu_clave'))
//     .then(b => console.log([...new Uint8Array(b)].map(x=>x.toString(16).padStart(2,'0')).join('')))
const UPLOAD_PASSWORD_HASH = '3d9c3ff60ba18938f9ec294a04ba0dad953aa9eca2ddba8fbec9a31e09e8f974';
