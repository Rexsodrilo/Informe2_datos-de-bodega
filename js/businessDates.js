...
/**
 * Horas hábiles transcurridas entre `from` y `to` (mismo horario 09:00-18:00,
 * lunes a viernes, usado en toda la app). A diferencia de una simple resta de
 * fechas, no cuenta noches ni fines de semana como "atraso".
 */
