...
// Fecha de referencia inicial para el modo "Día": ayer, no hoy — el día en
// curso todavía no está cerrado, así que "hoy" nunca tiene información
// completa que mostrar por defecto.
function yesterday() {
  const d = new Date();
...
function renderKpiTab() {
  ...
  if (dateInput) dateInput.value = toDateInputValue(state.kpiRefDate);
